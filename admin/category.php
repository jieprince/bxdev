...
if ($_REQUEST['act'] == 'insert')
{
    ...
    $cat['is_show_in_appwebview']        = isset($_POST['is_show_in_appwebview'])  ? $_POST['is_show_in_appwebview']      : 0;
    $cat['is_show_in_weixin']        = isset($_POST['is_show_in_weixin'])        ? $_POST['is_show_in_weixin']      : 0;
    $cat['is_show_in_app']        = isset($_POST['is_show_in_app'])        ? $_POST['is_show_in_app']      : 0;
    $cat['icon_show_in_app']        = isset($_POST['icon_show_in_app'])        ? $_POST['icon_show_in_app']      : "";
	...
	$category_img = $image->upload_image($_FILES['category_img'],'category_img');
    $cat['category_img'] = $category_img;
    
	$background_img = $image->upload_image($_FILES['background_img'],'background_img');
    $cat['background_img'] = $background_img;
...
if ($_REQUEST['act'] == 'update')
{
	...
	if ((isset($_FILES['category_img']['error']) && $_FILES['category_img']['error'] == 0) || (!isset($_FILES['category_img']['error']) && isset($_FILES['category_img']['tmp_name']) && $_FILES['category_img']['tmp_name'] != 'none'))
	{
	 	$image->data_dir = 'images';
		$category_img = $image->upload_image($_FILES['category_img'],'category_img');
	}
	...
	{
		$category_img = $_REQUEST['old_category_img'];
		
	}
	$cat['category_img'] = $category_img;
	
	
	if ((isset($_FILES['background_img']['error']) && $_FILES['background_img']['error'] == 0) || (!isset($_FILES['background_img']['error']) && isset($_FILES['background_img']['tmp_name']) && $_FILES['background_img']['tmp_name'] != 'none'))
	{
	 	$image->data_dir = 'images';
		$background_img = $image->upload_image($_FILES['background_img'],'background_img');
	}
	...
	{
		$background_img = $_REQUEST['old_background_img'];
