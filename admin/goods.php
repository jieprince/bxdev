...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    if ($is_add)
    {
		 ...
		 * 添加页获得保险信息
		 */
        //add by wangcya , 20140804
		$sql = "SELECT attribute_id, attribute_name FROM t_insurance_product_attribute";
        $bx = $db->getAll($sql);
    }//end $is_add
    else
    {
        ...
        //added by zhangxi, 20150130,活动相关信息查询获取，根据goods表中的activity_id
        $activity_id = $goods['activity_id'];
        $sql = "SELECT * FROM " . $ecs->table('favourable_activity') . " WHERE act_id = '$activity_id'";
		$activity_info = $db->getRow($sql);//获得当前商品的活动信息
		$smarty->assign('activity_info',$activity_info);
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $detail_url = isset($_POST['detail_url']) ? trim($_POST['detail_url']) : '0';
    
    
    $proxy_percent = $_POST['proxy_percent'] ;
    $organization_percent	 = $_POST['organization_percent'];
    $introducer_percent		 = $_POST['introducer_percent'];
	...
	//add yes123 判断险种是否已经关联了其他goods，一对一关系，一个险种不能关联多个商品 $_POST[baoxian],所以先清空之前的
	$tid  = $_POST['baoxian'];
	$sql = "UPDATE bx_goods SET tid=0 WHERE tid='$tid'";
	$db->query($sql);
    ...
    { 
        ...
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id,tid,proxy_percent,organization_percent,introducer_percent,detail_url)" .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    ...
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id',$_POST[baoxian],'$proxy_percent','$organization_percent','$introducer_percent','$detail_url')";
        ...
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral, tid,detail_url)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral', $_POST[baoxian],'$detail_url')";
        }
    }
    else
    {
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
                ...
                "introducer_percent = '$introducer_percent', " .
