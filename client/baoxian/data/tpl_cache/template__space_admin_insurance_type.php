<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template//space_admin_insurance_type|template//header|template//space_admin_sidebar|template//footer', '1417748412', 'template//space_admin_insurance_type');?><!DOCTYPE html>
...
<ul>
    ...
    <li class="button-80" onmouseover="this.className='button-over-80';" onmouseout="this.className='button-80';">
        <a href="cp.php?ac=admin_insurance_type">
...
<input name="do" value="admin_insurance_type" type="hidden">
<input name="view" value="insurance_type" type="hidden">
</form>	
...
<form name="productForm" method="post" action="cp.php?ac=admin_insurance_type&op=delete">
...
<td width="15%">修改</td>
      ...
      <?php if(is_array($list)) { foreach($list as $key => $value) { ?>   
            ...
            <tr class="tdContent">
                ...
                <td>
<input name="ids[]" value="<?=$value['id']?>" type="checkbox">
</td>
 ...
 <td>
             <a href="cp.php?ac=admin_insurance_type&id=<?=$value['id']?>" target="_self"><img src="template/images/updateButton.gif" alt="修改">
            修改</a>
             </td>
