<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template//cp_admin_insurance_product_duty|template//header|template//space_admin_sidebar|template//footer', '1418700302', 'template//cp_admin_insurance_product_duty');?><!DOCTYPE html>
...
<form name="insuranceKindForm" method="POST" action="cp.php?ac=admin_insurance_product_duty&product_id=<?=$product_id?>&product_duty_id=<?=$product_duty['product_duty_id']?>">


<input type="hidden" name="product_duty_submit" id="product_duty_submit" value="true" />
...
<td class="tdEditArea">保险责任：</td>  
<td class="tdEditArea">责任代码：</td>
<td class="tdEditArea">保险金额：</td>
    <td class="tdEditArea">保障范围描述：</td>
   		
    </tr>

<?php if(is_array($list_count)) { foreach($list_count as $key => $value) { ?>
    <tr>
        
        <td class="tdEditArea">

 	<input name="productduty[<?=$key?>][duty_name]" id="duty_name_<?=$key?>" value="" class="ref" type="text">
 	<span>（*）</span>
 
 <!--
            <input type="hidden" name="insurer_id" id="insurer_id" value="product[insurer_id]"/>
    <input type="hidden" name="duty_id" id="duty_id" value="product_duty[duty_id]"/>
-->	

<ul id="duty_name_list" style="display:none;">
        ...
        <td class="tdEditArea">
            ...
            <input name="productduty[<?=$key?>][duty_code]" id="duty_code_<?=$key?>" value="" type="text">
        ...
        <td class="tdEditArea">
            ...
            <input name="productduty[<?=$key?>][amount]" id="duty_amount_<?=$key?>" value="" type="text">
...
<textarea name="productduty[<?=$key?>][duty_note]" id="duty_note_<?=$key?>" rows="2" class=""></textarea>
