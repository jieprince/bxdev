...
//            "a.goods_price * a.goods_number AS subtotal, a.extension_code,b.goods_id,b.goods_thumb, " .
//            " ipa.insurer_name ".
//            "FROM " . $GLOBALS['ecs']->table('order_goods') . " a," . $GLOBALS['ecs']->table('goods') . " b, t_insurance_product_attribute ipa WHERE ipa.attribute_id=b.tid AND b.goods_id=a.goods_id and a.order_id = '$order_id'";

 $sql = "SELECT a.rec_id, a.goods_id, a.goods_name, a.goods_sn, a.market_price, a.goods_number, " .
            "a.goods_price, a.goods_attr, a.is_real, a.parent_id, a.is_gift, " .
            "a.goods_price * a.goods_number AS subtotal, a.extension_code,b.goods_id,b.goods_thumb, " .
            " ipa.insurer_name, brand.brand_name ".
            "FROM " . $GLOBALS['ecs']->table('order_goods') . " a," . $GLOBALS['ecs']->table('goods') . " b, t_insurance_product_attribute ipa ,bx_brand brand WHERE brand.brand_id=b.brand_id AND ipa.attribute_id=b.tid AND b.goods_id=a.goods_id and a.order_id = '$order_id'";
