...
$j(document).ready(function(){
	...
	var start_st = timeStamp2String(time,30,'year'); 
	$('#startDate_baoxian').text(time+' 00:00:00'); 
	$('#endDate_baoxian').text(start_st); 
	$('#startDate_Temps').val(time+' 00:00:00'); 
	$('#endDate_Temps').val(start_st); 
...
function check_buy_submit_xinhuashaoer(){
	...
	if(!check_All_card('applicant_certificates_type','applicant_certificates_code',1,true,'applicant_birthday','applicant_sex')){
