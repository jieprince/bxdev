...
$j(document).ready(function(){
    ...
    //end add by wangcya , 20141121,服务器时间
	 ...
	 if($('#personal_protection').val()!='no'){
		 checkedset_M();
		 $('#property_list input[type="checkbox"]').click(function(){
			 checkedset_M();
		 });	 
	 }
 ...
 function check_buy_submit_pinganYMain(){
	        ...
	        */
	        ...
	        else if (!check_applicant_email())
	        {
	            ...
	            return false;
	        }else if(!checkAllEditTag_Null('applicant_address')){
			...
			var str_jsondata = [{'type':2,'fullname':$('#applicant_fullname').val(),'relation':'主被保险人','p_1':$('#s_03_00').text(),'p_2':$('#s_04_00').val()}];
			var s_01Temps = $('#s_01_01').attr("checked");
			var s_02Temps = $('#s_01_02').attr("checked");
			var s_03Temps = $('#s_01_03').attr("checked");
			if(s_01Temps){
				if(!$('#s_02_01').val()){
					window.setTimeout("document.getElementById('s_02_01').focus();", 0)  ; 
	            	return false;
				}
				str_jsondata.push({'type':0,'fullname':$('#s_02_01').val(),'relation':'配偶','p_1':$('#s_03_01').text(),'p_2':$('#s_04_01').val()});
			}
			if(s_02Temps){
				if(!$('#s_02_02').val()){
					window.setTimeout("document.getElementById('s_02_01').focus();", 0)  ; 
				...
				str_jsondata.push({'type':0,'fullname':$('#s_02_02').val(),'relation':'子女一','p_1':$('#s_03_02').text(),'p_2':$('#s_04_02').val()});
			}
			if(s_03Temps){
				if(!$('#s_02_03').val()){
					window.setTimeout("document.getElementById('s_02_01').focus();", 0)  ; 
				...
				str_jsondata.push({'type':0,'fullname':$('#s_02_03').val(),'relation':'子女二','p_1':$('#s_03_03').text(),'p_2':$('#s_04_03').val()});
			}
