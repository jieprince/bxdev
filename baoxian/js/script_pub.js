...
function fPopUpCalendarDlg(ctrlobj) {
   ...
   var retval = window.showModalDialog("../common/html/CalendarDlg.shtml", "","dialogWidth:197px; dialogHeight:210px; dialogLeft:" + showx +"px; dialogTop:" + showy +"px; status:no; directories:yes;scrollbars:no;Resizable=no; ");
   if (retval != null) {
...
function closeChildWindow(fatherForm, childForm, metType) {
    childForm.metType.value = metType;
    ...
    function closeChildWindowNew(childForm, metType) {
    childForm.metType.value = metType;
...
function dateDiff(interval, date1, date2){
 ...
 try
 {
    return Math.round((date1.getTime() - date2.getTime()) / eval('objInterval.'+interval));
  }
  catch (e){
    return e.message;
  }
