...
$_SGLOBAL['msglang'] = array(
	...
	'no_privilege_avatar_xml' => '您需要设置自己的头像后才能进行本操作!',
	...
	'uniquecertno_check' => '您填入的医师执业证号已经被占用，请尝试使用其他证号',
	'unique_name_check' => '该名字已经被占用！',
	'unique_weibo_check' => '您填入的微博地址被注册，请尝试使用其他微博地址',
	//mt.php
	'designated_election_it_does_not_exist' => '指定的圈子不存在，您可以尝试创建',
	'mtag_tagname_error' => '设置的圈子名称不符合要求',
	'mtag_join_error' => '加入指定的圈子失败，请尝试搜索现有的相关圈子，并在相应的圈子中申请成为会员',
	'mtag_join_field_error' => '圈子分类 \\1 下面最多只允许加入 \\2 个圈子，您已经到达上限',
	'mtag_creat_error' => '您要查看的圈子目前还没有被创建',
	'drugs_notnull_error' => '您有些项没有填写',
	'drugs_submit_success' => '药品资料提交成功',
	'drugs_uniquecertno_check' => '您提交的药品批准文号已经存在',
	'haved_existence' => '您提交的信息已经存在',
	'beyond_limit_count' => '一小时之内最多只能访问\\1次',
	//index.php
	'enter_the_space' => '进入个人空间页面',
	'symptom_uniquecertno_check' => '您提交的疾病症状已经存在',
	'symptom_submit_success' => '疾病症状资料提交成功',
	//network.php
	...
	//source/cp_mtag.php
	'mtag_managemember_no_privilege' => '您不能对当前选定的成员进行圈子权限变更操作，请重新选择',
	'mtag_max_inputnum' => '无法加入，您在栏目 "\\1" 中的圈子数目已达到 \\2 个限制数目',
	'you_are_already_a_member' => '您已经是该圈子的成员了',
	'join_success' => '加入成功，您现在是该圈子的成员了',
	'the_discussion_topic_does_not_exist' => '对不起，参与讨论的话题不存在',
	'content_is_not_less_than_four_characters' => '对不起，内容不能少于2个字符',
	'you_are_not_a_member_of' => '您不是该圈子的成员',
	'unable_to_manage_self' => '您不能对自己进行操作',
	'mtag_joinperm_1' => '您已经选择加入该圈子，请等待圈主审核您的加入申请',
	'mtag_joinperm_2' => '本圈子需要收到圈主邀请后才能加入',
	'invite_mtag_ok' => '成功加入该圈子，您可以：<a href="space.php?do=mtag&tagid=\\1" target="_blank">立即访问该圈子</a>',
	'invite_mtag_cancel' => '忽略该圈子邀请完成',
	'failure_to_withdraw_from_group' => '退出私密圈子失败,请先指定一个主圈主',
	'fill_out_the_grounds_for_the_application' => '请填写圈主申请理由',
	...
	'not_empty_please_re_set' => '对不起，信息填写不全，请重新填写',//add by wangcya ,20120819
	'add_successful_individuals' => '增加成功！',//add by wangcya ,20120819
	'modify_successful_individuals' => '修改成功！',//add by wangcya ,20120819
	'delete_successful_individuals' => '删除成功！',//add by wangcya ,20120819
	'input_too_long' => '输入太长！',//add by wangcya ,20120819
	'no_authority_management_operation' => '对不起,您没有权限进行本管理操作',
	'need_login' => '需要登录！',//add by wangcya ,20120819
	//source/cp_poll.php
	...
	'mtag_fieldid_does_not_exist' => '指定的圈子分类不存在',
	...
	'settings_of_your_mtag' => '有了圈子才能发话题，你需要先设置一下你的圈子。<br>通过圈子，您可以结识与你有相同选择的朋友，更可以一起交流话题。<br><br><a href="cp.php?ac=mtag" class="submit">设置我的圈子</a>',
	'first_select_a_mtag' => '你至少应该选择一个圈子才能发话题。<br><br><a href="cp.php?ac=mtag" class="submit">设置我的圈子</a>',
	'no_mtag_allow_thread' => '当前你参与的圈子加入人数不足，还不能进行发话题操作。<br><br><a href="cp.php?ac=mtag" class="submit">设置我的圈子</a>',
	'mtag_close' => '选择的圈子已经被锁定，不能进行本操作',
	...
	'not_open_registration_invite' => '非常抱歉，本站目前暂时不允许用户直接注册，需要有好友邀请链接或者第三方登录才能注册',
	...
	'getpasswd_send_succeed_app' => '取回密码的方法已经通过 Email 发送到您的信箱 \\1 中，<br />请在 3 天之内修改您的密码。',
	...
	'email_code_checked_wrong' => '邮箱验证码错误',	
	...
	'mtag_minnum_erro' => '本圈子成员数不足 \\1 个，还不能进行本操作',
	...
	'incorrect_code' => '输入的图形验证码不符，请重新确认',
	...
	'mtag_not_allow_to_do' => '您不是该话题所在圈子的成员，没有权限进行本操作',
	...
	'event_mtag_not_match' => '指定圈子没有关联到本活动',
	...
	'magic_gift_already_given_out' => '代金券已经被领完了',
	'magic_got_gift' => '您已经领取到了代金券：增加 \\1 个积分',
	'magic_had_got_gift' => '您已经领取过此次代金券了',
	'magic_has_no_gift' => '当前空间没有设置代金券',
	...
	'topic_list_none' => '目前还没有可以参与的热闹',
     //已被锁定
	'space_has_been_locked' => '空间无法访问，如有疑问请联系管理员',
	'content_shouldnot_null' => '内容不能为空',
	'file_shouldnot_null' => '没有选择文件',
	'uniquecertno_collect' => '您选择的已经收藏过了！',
	'cannot_askto_yourself' => '您不能向自己提问！',
	'only_patient_askto_doctor' => '只能患者向医生提问！',
	'should_write_longger' => '您提交的问题过于简单，可能医生无法做出有价值的回复，请完善问题，至少25个汉字！',
	'do_ask_success'=> '您提问剩余次数为： \\1',
	'do_ask_limit'=> '您提问次数已经耗尽！',
	'beyond_price_limit'=> '设置价格超过范围！',
	'beyond_tags_limit'=> '超过个人标签数目限制！',
	'same_maindp'=> '转诊的科室和问题的原科室不能相同！',
	'unique_mobilenum_check'=>'该手机号码被占用',
	'not_allow_by_doctor'=>'医生暂时不允许该操作！',
	'account_not_enough'=>'您账号余额不够，请充值！',
	'recharge_success'=>'充值成功！',
	'wealth_account_noinit'=>'您的账号还没初始化，现在自动初始化！',
	'wealth_account_failinit'=>'账号初始化失败，请联系管理员！',
	'wealth_account_noalipay'=>'您还没设置支付宝账号，请设置！',
	'wealth_account_setok'=>'支付宝账号设置成功！',
	'diseaseinfo_submit_success'=>'药品信息提交成功，等待审核通过！',
