...
$_SGLOBAL['cplang'] = array(
	...
	'choose_to_delete_the_columns_tag' => '请至少正确选择一个要删除的圈子',

	'designated_to_merge_the_columns_do_not_exist' => '要合并到的新圈子还没有创建，请先自行创建此圈子后再进行合并',

	'the_successful_merger_of_the_designated_columns' => '合并指定的圈子成功了',

	'columns_option_to_merge_the_tag' => '请至少正确选择一个要合并的圈子',

	'lock_open_designated_columns_tag_success' => '锁定/开放指定的圈子成功了',

	'recommend_designated_columns_tag_success' => '推荐/取消推荐指定的圈子成功了',

	'choose_to_operate_columns_tag' => '请至少正确选择一个要操作的圈子',
	...
	'there_is_no_designated_users_columns' => '指定操作的圈子栏目不存在',

	'choose_to_delete_the_columns' => '请正确选择要删除的栏目',

	'have_one_mtag' => '删除失败，请至少要保留一个圈子栏目',
