...
function ss_log($msg)
{
	$ss_log_filename = "/var/www/html/log/ucenter.log";
	///////////////////////////////////////////////////
	if(1)
	{
...
class ucserver_db {
	...
	function connect($dbhost, $dbuser, $dbpw, $dbname = '', $dbcharset = '', $pconnect = 0, $tablepre='', $time = 0) {
		...
		$this->time = $time;				//$msg = "$dbhost $dbuser $dbpw $dbname $tablepre";//add by wangcya , 20131028		$msg ="";
        //ss_log($msg);
		if($pconnect) {
			if(!$this->link = mysql_pconnect($dbhost, $dbuser, $dbpw)) {
				$this->halt('Can not connect to MySQL server'.$msg);
			}
		} else {
