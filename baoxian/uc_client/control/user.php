...
class usercontrol extends base {
	...
	{
		/*
		//start add by wangcya, 20130109,for bug[309]
		if($_SGLOBAL['mobile_type'] != 'myself')//add by wangcya, 20130109,for bug[309]
		{
			return 1;
		}
		//end add by wangcya, 20130109,for bug[309]
		*/
