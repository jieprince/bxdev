...
$attr_certificates_type_ssbq = array(
		'01' => '身份证',
		'02' => '港澳台证件'
);
...
$attr_group_certificates_type_ssbq =  array(
		6 => '组织机构代码证'//mod by zhangxi, 20150123, 必须与批量投保下拉框内容完全一致
);
$attr_certificates_type_ssbq_tj_property = array(
		1 => '身份证',
		2 => '护照',
		3 => '其他',
);
//<!--（可空）团体证件类型，-->
$attr_group_certificates_type_ssbq_tj_property =  array(
		4 => '组织机构代码证',
		5 => '营业证号',
		6 => '其他',
);
$attr_industry_type_ssbq_tj_property = array(
									'A'=>'农、林、牧、渔业',
									'B'=>'采矿业',
									'C'=>'制造业',
									'D'=>'电力、燃气及水的生产和供应业',	
...
$attr_benefit_type_ssbq_tj_property = array(
									0 => '其他',
									1 => '法定',
									2 => '均分',
									3 => '比例',
...
$attr_company_attribute_type_ssbq = array();
...
$attr_sex_ssbq_tj_property = array(
		1 => '男',
		2 => '女',
);
$attr_relationship_with_insured_ssbq = array(
		1 => '本人',
		2 => '配偶',
		3 => '子女',
		4 => '父母',
...
$attr_relationship_with_insured_ssbq_tj_property = array(
		0 => '本人',
		1 => '配偶',
		2 => '子女',
		3 => '父母',
...
$G_XLS_UPLOAD_FORMAT_ssbq_YIWAI = array(
...
$G_XLS_UPLOAD_FORMAT_ssbq_TUANDAN = array(
...
$attr_certificates_type_ssbq_single_unify = array(
		"1"=>1,//'身份证';
		"4"=>2,//'驾驶证';
		"3"=>3,//'军官证';
		"2"=>4,//'护照';
...
$attr_certificates_type_ssbq_tj_property_single_unify = array(
		"1"=>1,//'身份证';
		"2"=>4,//'护照';
		"3"=>9,//'其他';
);

$attr_certificates_type_ssbq_group_unify = array(
		"6"=>10,//"组织机构代码证"
		//"02"=>11,//"税务登记证"
		//"03"=>12//"异常证件"
);
$attr_certificates_type_ssbq_tj_property_group_unify = array(
		"4"=>10,//"组织机构代码证"
		//"02"=>11,//"税务登记证"
		//"03"=>12//"异常证件"
);

$attr_sex_ssbq_unify = array(
		"2"=>"F",
		"1"=>"M",
);
$attr_sex_ssbq_tj_property_unify = array(
		"2"=>"F",
		"1"=>"M",
);
...
//需要上传的文件
//个人信息
/*$personal_info_attr = array(
		'personal_info_1'=>array('name'=>'身份证复印件、户口簿复印件、结婚证复印件','is_required'=>0,'sort_order'=>1),
		'personal_info_2'=>array('name'=>'工作证明复印件、工资证明复印件','is_required'=>0,'sort_order'=>2),
		'personal_info_3'=>array('name'=>'住所的房产证明复印件','is_required'=>0,'sort_order'=>3),
		'personal_info_4'=>array('name'=>'被保险人主要财产的权属证明文件','is_required'=>0,'sort_order'=>4),
);

//企业信息
$company_info_attr = array(
		'company_info_1'=>array('name'=>'法定代表人/负责人/执行合伙人/个人独资企业经营者身份证复印件','is_required'=>0,'sort_order'=>1),
		'company_info_2'=>array('name'=>'企业法人营业执照、企业税务登记证、组织机构代码证（盖公章）','is_required'=>0,'sort_order'=>2),
		'company_info_3'=>array('name'=>'公司章程复印件（盖公章）','is_required'=>0,'sort_order'=>3),
		'company_info_4'=>array('name'=>'被保险人主要财产的权属证明文件','is_required'=>0,'sort_order'=>4),
		'company_info_5'=>array('name'=>'近年财务报表（近一年）','is_required'=>0,'sort_order'=>4),
);


//档案 ，公共部分
$records_attr = array(
		'records_1'=>array('name'=>'起诉状复印件','is_required'=>1,'sort_order'=>1),
		'records_2'=>array('name'=>'立案通知书(或案件受理通知书) 复印件（如有','is_required'=>1,'sort_order'=>2),
		'records_4'=>array('name'=>'诉讼保全申请书复印件','is_required'=>1,'sort_order'=>3),
		'records_4'=>array('name'=>'财产保全标的物明细清单（若财产被封，提供财产线索，账户信息','is_required'=>1,'sort_order'=>4),
		'records_5'=>array('name'=>'证明原被告法律关系存在的证据','is_required'=>1,'sort_order'=>5),
		'records_6'=>array('name'=>'证明被告违约或侵权事实的证据','is_required'=>1,'sort_order'=>6),
		'records_7'=>array('name'=>'证据清单复印件、提交法院的证据材料复印件','is_required'=>1,'sort_order'=>7),
		'records_8'=>array('name'=>'答辩状复印件（如有）','is_required'=>1,'sort_order'=>8),
		'records_9'=>array('name'=>'投保问卷','is_required'=>0,'sort_order'=>9),
		'records_10'=>array('name'=>'法律意见书','is_required'=>0,'sort_order'=>10)
);


//被告人信息
$defendant_attr = array(
		'defendant_01'=>array('name'=>'在全国企业信用信息公示系统中经公开检索查询到的企业基本信息','is_required'=>0,'sort_order'=>1),
		'defendant_02'=>array('name'=>'被告的身份证复印件（被告为自然人） ','is_required'=>0,'sort_order'=>2),
);
*/

/*其他*/
$other_file_attr = array(
		'other_file_01'=>array('name'=>'投保问卷（盖公章）','is_required'=>0,'sort_order'=>10),
		'other_file_02'=>array('name'=>'企业法人营业执照、企业税务登记证、组织机构代码证（盖公章）','is_required'=>0,'sort_order'=>20),
		'other_file_03'=>array('name'=>'法定代表人/负责人/执行合伙人/个人独资企业经营者身份证复印件','is_required'=>0,'sort_order'=>30),
		'other_file_04'=>array('name'=>'被保险人主要财产的权属证明文件','is_required'=>0,'sort_order'=>40),
		'other_file_05'=>array('name'=>'证明原被告法律关系存在的证据','is_required'=>0,'sort_order'=>50),
		'other_file_06'=>array('name'=>'证明被告违约或侵权事实的证据','is_required'=>0,'sort_order'=>60),
		'other_file_07'=>array('name'=>'证明诉讼请求金额的计算依据','is_required'=>0,'sort_order'=>70),
		'other_file_14'=>array('name'=>'法律意见书','is_required'=>0,'sort_order'=>75),
		'other_file_08'=>array('name'=>'近年财务报表（近一年）','is_required'=>0,'sort_order'=>80),
		'other_file_09'=>array('name'=>'公司章程复印件（盖公章）','is_required'=>0,'sort_order'=>90),
		'other_file_10'=>array('name'=>'身份证复印件、户口簿复印件、结婚证复印件（仅针对个人投保人）','is_required'=>0,'sort_order'=>100),
		'other_file_11'=>array('name'=>'工作证明复印件、工资证明复印件（仅针对个人投保人）','is_required'=>0,'sort_order'=>110),
		'other_file_12'=>array('name'=>'住所的房产证明复印件（仅针对个人投保人）','is_required'=>0,'sort_order'=>120),
		'other_file_13'=>array('name'=>'委托书','is_required'=>0,'sort_order'=>15),
		
);

/*必须上传的文件*/
$required_upload_file_attr = array(
		'vital_info_1'=>array('name'=>'起诉状复印件','is_required'=>1,'sort_order'=>10),
		'vital_info_2'=>array('name'=>'诉讼保全申请书复印件','is_required'=>1,'sort_order'=>20),
		'vital_info_3'=>array('name'=>'财产保全标的物明细清单','is_required'=>1,'sort_order'=>30),
		'vital_info_4'=>array('name'=>'证据清单复印件、提交法院的证据材料复印件','is_required'=>1,'sort_order'=>40),
		'vital_info_5'=>array('name'=>'已立案证明文件（法院诉讼发票或立案通知书）','is_required'=>1,'sort_order'=>50),
		'vital_info_6'=>array('name'=>'答辩状复印件（如有）','is_required'=>1,'sort_order'=>60),
...
$java_class_name_ssbq = 'com.yanda.imsp.util.ins.ssbqPolicyFecher';

function input_check_ssbq_tj_family_property($product, $POST)
{
	global $_SGLOBAL;
	global $attr_certificates_type_ssbq_tj_property_single_unify;
	global $attr_certificates_type_ssbq_tj_property_group_unify;
	global $attr_sex_ssbq_tj_property_unify;
...
/*	if(	!isset($POST['applyNum'])||
	...
	{
		$user_info_applicant['applicant_type'] = isset($POST['applicant_type'])?intval($POST['applicant_type']):1;
		...
		$user_info_applicant['law_office'] = isset($POST['applicant_shiwusuo'])?trim($POST['applicant_shiwusuo']):''; //律师事务所
		$user_info_applicant['cus_contact'] = isset($POST['applicant_fullname2'])?trim($POST['applicant_fullname2']):''; //律师事务所
		...
		$user_info_applicant['certificates_type_unify'] = $attr_certificates_type_ssbq_tj_property_single_unify[$user_info_applicant['certificates_type']];
		$user_info_applicant['gender_unify'] = $attr_sex_ssbq_tj_property_unify[$user_info_applicant['gender']];
	...
	if($businessType == 1)//个单情况
	{
		...
		{//new
			...
			$assured_info['certificates_type_unify'] = $attr_certificates_type_ssbq_tj_property_single_unify[$assured_info['certificates_type']];
			$assured_info['gender_unify'] = $attr_sex_ssbq_tj_property_unify[$assured_info['gender']];
...
function input_check_ssbq_tj_property($product, $POST)
{
	ss_log("into input_check_ssbq_tj_property ");
	global $_SGLOBAL;
	global $attr_certificates_type_ssbq_tj_property_single_unify;
	global $attr_certificates_type_ssbq_tj_property_group_unify;
	global $attr_sex_ssbq_tj_property_unify;
...
/*	if(	!isset($POST['applyNum'])||
	...
	if($businessType == 1)//个人
	{
		...
		$user_info_applicant['law_office'] = isset($POST['law_office'])?trim($POST['law_office']):'';
		$user_info_applicant['cus_contact'] = isset($POST['applicant_fullname2'])?trim($POST['applicant_fullname2']):''; //律师事务所
	...
	else//团体投保人
	{
		...
		$user_info_applicant['group_certificates_type_unify'] = $attr_certificates_type_ssbq_tj_property_group_unify[$user_info_applicant['group_certificates_type']];
		$user_info_applicant['agent_uid'] = $agent_uid;
		//end add by wangcya, 20141219 ,不同厂商的证件号码和性别统一
	}
	//以上是投保人信息处理
...
//
function input_check_ssbq($POST)
{
	global $_SGLOBAL,$attr_certificates_type_ssbq_single_unify;
	global $attr_certificates_type_ssbq_group_unify;
	global $attr_sex_ssbq_unify;
	////////////////////////////////////////////////////////////////////////////////////////
	$agent_uid = $_SGLOBAL['supe_uid'];//add by wangcya, 20141219 ,不同厂商的证件号码和性别统一
	...
	ss_log("input_check_ssbq, businessType: ".$businessType);
	//////////////////有效性检查//////////////////////////////////////////////////////
...
/*	if(	!isset($POST['applyNum'])||
	...
	if($businessType == 1)//个人
	{
		$user_info_applicant['applicant_type'] = isset($POST['applicant_type'])?intval($POST['applicant_type']):1; //投保人类型
		$user_info_applicant['certificates_type'] = $POST['applicant_certificates_type'];
		$user_info_applicant['certificates_code'] = $POST['applicant_certificates_code'];
		$user_info_applicant['fullname'] = $POST['applicant_fullname'];
		$user_info_applicant['gender'] = $POST['applicant_sex'];
		...
		$user_info_applicant['zipcode'] = $POST['applicant_zipcode'];
		$user_info_applicant['address'] = $POST['applicant_address'];
		$user_info_applicant['law_office'] = isset($POST['applicant_shiwusuo'])?trim($POST['applicant_shiwusuo']):"";
		$user_info_applicant['cus_contact'] = isset($POST['applicant_fullname2'])?trim($POST['applicant_fullname2']):''; //律师事务所
		...
		/////////////////////////////////////////////////
		//start add by wangcya, 20141219 ,不同厂商的证件号码和性别统一
		$user_info_applicant['certificates_type_unify'] = $attr_certificates_type_ssbq_single_unify[$user_info_applicant['certificates_type']];
		$user_info_applicant['gender_unify'] = $attr_sex_ssbq_unify[$user_info_applicant['gender']];
		$user_info_applicant['type'] = 1;//0,被保险人，1投保人,2两者身份相同
		$user_info_applicant['agent_uid'] = $agent_uid;
		//end add by wangcya, 20141219 ,不同厂商的证件号码和性别统一
	...
	else//团体投保人
	{
		...
		//add by wangcya, 20141219 ,不同厂商的证件号码和性别统一
		$user_info_applicant['group_certificates_type_unify'] = $attr_certificates_type_ssbq_group_unify[$user_info_applicant['group_certificates_type']];
		$user_info_applicant['agent_uid'] = $agent_uid;
		//end add by wangcya, 20141219 ,不同厂商的证件号码和性别统一
	}
	...
	{//new
		...
		//add by wangcya, 20141219 ,不同厂商的证件号码和性别
		$assured_info['certificates_type_unify'] = $attr_certificates_type_ssbq_single_unify[$assured_info['certificates_type']];
		$assured_info['gender_unify'] = $attr_sex_ssbq_unify[$assured_info['gender']];
		$assured_info['type'] = 0;//0,被保险人，1投保人,2两者身份相同
		$assured_info['agent_uid'] = $_SGLOBAL['supe_uid'];
		//end add by wangcya, 20141219 ,不同厂商的证件号码和性别
...
//检查太平洋的输入的函数,批量投保方式
function input_check_ssbq_bat($POST)
{
...
/*	if(	!isset($POST['applyNum'])||
	...
	ss_log("in input_check_ssbq_bat, post applyNum".$POST['applyNum']);
	ss_log("in input_check_ssbq_bat, post totalModalPremium: ".$POST['totalModalPremium']);
	ss_log("in input_check_ssbq_bat, post totalModalPremium_single: ".$POST['totalModalPremium_single']);
	...
	ss_log("in input_check_ssbq_bat, global_info applyNum: ".$real_apply_num);
...
function gen_ssbq_tj_personal_accident_xml_header($policy_attr,//保单相关信息
...
//太平洋天津室内工程一切险
function gen_ssbq_tj_project_xml($policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode)
{
...
function gen_ssbq_tj_family_property_xml($policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode)
{
...
function gen_ssbq_tj_personal_accident_xml_body($policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject)
{
	ss_log("into function ".__FUNCTION__);
...
function gen_post_policy_xml_ssbq_tj_property($attribute_type,
										  $policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode											
		                                   )
{
	...
	{
		$str_xml = gen_ssbq_tj_family_property_xml($policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode);
	}
	...
	{
		$str_xml = gen_ssbq_tj_project_xml($policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode);
	}
	...
	{//人意，君安行等。
		$header = gen_ssbq_tj_personal_accident_xml_header($policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode);
		$body = gen_ssbq_tj_personal_accident_xml_body($policy_attr,//保单相关信息
												$user_info_applicant,//投保人信息
												$list_subject);
		$str_xml = '<?xml version="1.0" encoding="UTF-8"?>
					<request>
...
function gen_post_policy_xml_ssbq(  $policy_attr,//保单相关信息
											$user_info_applicant,//投保人信息
											$list_subject,
											$partnerCode											
		                                   )
{
	...
	ss_log("into function gen_post_policy_xml_ssbq");
	/////////////////////////////////////////////////////////
	$result = 1;
	$retmsg = "";
	...
	ss_log("ssbq rand gen UUID: ".$UUID);
	///////////////////////////////////////////////////////////////////////
	...
	ss_log("ssbq business_type ".$groupPolicy);
...
function get_policy_pdf_file_ssbq_tj_property($policy_id,
												$order_sn,
												 $pdf_filename, 
												 $pdf_buffer,
												 $readfile=false )
{
	if(!isset($obj_java))
	{
		$obj_java = create_java_obj("com.yanda.imsp.util.ins.ssbq.traffic.ssbqTrafficIns");
	}
	if(!$obj_java)
	{
		$result = 112;
	...
	$logFileName = S_ROOT."xml/log/ssbq_tj_property_download_policyfile_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
	
	ss_log(__FUNCTION__.",ssbq property order_sn: ".$order_sn);
	ss_log(__FUNCTION__.",ssbq property pdf_buffer: ".$pdf_buffer);
...
function process_return_xml_data_ssbq_tj_property( $policy_attr,
													$policy_id,
							                      	$orderNum,
													$order_sn,
													$return_data)
	...
	if($messageStatusCode == '000000' )//ok
	{
		...
		if($partnerCode == PARTNERCODE_TJ_FAMILY_PROPERTY)//新系统，太保家财，太保建工
		{
			...
			if($policy_id)//根据返回的找到了对应的保单，old
			{
				...
				$pdf_filename = S_ROOT."xml/message/".$policyNo."_ssbq_tj_property_policy.pdf";
				ss_log(__FUNCTION__." pdf policy filename: ".$pdf_filename);
				
				$policy_attr['readfile'] = false;//add by wangcya, 20150207
				$use_asyn = true;
				$result_attr = get_policyfile_ssbq_tj_family_property_xml(
											                $use_asyn,
											                $policy_attr,
															$pdf_filename
															);
		...
		else
		{
			...
			if($policy_id)//根据返回的找到了对应的保单，old
			{
				...
				{
					$result_attr = get_policy_pdf_file_ssbq_tj_property($policy_id,
													$order_sn,
													$pdf_filename, 
													 $epolicyPDF,
													 false );
...
//处理太平洋的返回数据
function process_return_xml_data_ssbq(
					                        $policy_id,
					                      	$orderNum,
											$order_sn,
											$return_data,
	...
	)//ok
	{
		...
		if($policy_id)//根据返回的找到了对应的保单，old
		{
			...
			if(1)//add by wangcya, 20150117,
			{
				...
				$pdf_filename = S_ROOT."xml/message/".$policyNo."_ssbq_policy.pdf";
				ss_log("pdf policy filename: ".$pdf_filename);
				
				$policy_attr['readfile'] = false;//add by wangcya, 20150207
				$use_asyn = true;
				$result_attr = get_policyfile_ssbq_yiwai_xml(
						                $use_asyn,
						                $policy_attr,
										$user_info_applicant,
										$list_subject,
...
function sendto_huanqiu_jiuyuan_ssbq(	
							    $order_sn,
								$policy_id,
								$strxml_post_policy_content,
								$return_data,
							    ...
							    )
{
	...
	if($insurer_code == "TBC01")//太平洋
	{
		...
		)
		{
			...
			$ret = ssbq_send_message_to_jiuyuan(
					$attribute_code,
					$order_sn,
					$policy_id,
					$strxml_post_policy_content,
...
function post_policy_ssbq_tj_property($attribute_type,
										$attribute_code,
										$policy_attr,
										$user_info_applicant,
										$list_subject)
{
	global $_SGLOBAL, $java_class_name_ssbq,$use_test_environmental;
	//////////////////////////////////////////////////////////////////////////////////////
	ss_log("into function ".__FUNCTION__);
	...
	$strxml_post_policy_content = gen_post_policy_xml_ssbq_tj_property(
															$attribute_type,
															$policy_attr,//保单相关信息
															$user_info_applicant,//投保人信息
															$list_subject,
	...
	if(!empty($strxml_post_policy_content))
	{
		//$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_tj_property_policy_post.xml";
		$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_tj_property_policy_post.xml");
		ss_log(__FUNCTION__.", ".$af_path);
		file_put_contents($af_path,$strxml_post_policy_content);

		//把携带序列号的也保存起来
		$FILE_UUID = getRandOnly_Id(0,1);
		//$af_path_serial = S_ROOT."xml/".$order_sn."_".$policy_id."_".$FILE_UUID."_ssbq_tj_property_policy_post.xml";
		$af_path_serial = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_".$FILE_UUID."_ssbq_tj_property_policy_post.xml");
		ss_log(__FUNCTION__.", ".$af_path_serial);
		file_put_contents($af_path_serial,$strxml_post_policy_content);

		ss_log(__FUNCTION__." ssbq will create_java_obj");
		//start add by wangcya, 20150112,for bug[203],启用异步方式和java通讯
		if(!defined('USE_ASYN_JAVA'))
		{
			$java_class_name = "com.yanda.imsp.util.ins.ssbqPolicyFecher";
		}
		else
		{
		...
		////////////////////////////////////////////////////////////////////
		//$ret_af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_tj_property_policy_post_ret.xml";
		$ret_af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_tj_property_policy_post_ret.xml");
		$url = URL_POST_POLICY_ssbq_TJ_PROPERTY;
		ss_log(__FUNCTION__." ssbq url: ".$url);
		$logFileName = S_ROOT."xml/log/ssbq_tj_property_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";	
		if(!defined('USE_ASYN_JAVA'))//同步方式
		{//同步方式
			//进行投保的工作
			ss_log(__FUNCTION__." ssbq will java applyPolicy");
			...
			{			
				ss_log(__FUNCTION__." ssbq will process return_data");
				...
				//////////////////////////////////////////////////////////////////////////
				$result_attr = process_return_xml_data_ssbq_tj_property(
											                        $policy_id,
											                      	$orderNum,
																	$order_sn,
		...
		else
		{
			...
			$logFileName = S_ROOT."xml/log/ssbq_tj_property_postpolicy_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
	...
	{
		ss_log(__FUNCTION__." ssbq tianjin property gen strxml null");
...
//进行投保的动作
function post_policy_ssbq_yiwai(
		...
		)
{
	...
	global $_SGLOBAL, $java_class_name_ssbq,$use_test_environmental;
	//////////////////////////////////////////////////////////////////////////////////////
	ss_log("into function post_policy_ssbq_yiwai");
	...
	$strxml_post_policy_content = gen_post_policy_xml_ssbq($policy_attr,//保单相关信息
									$user_info_applicant,//投保人信息
									$list_subject,
									$partnerCode
									);
	...
	if(!empty($strxml_post_policy_content))
	{
		//$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_post.xml";
		$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_post.xml");
		ss_log($af_path);
		file_put_contents($af_path,$strxml_post_policy_content);

		//start add by wangcya, 20150209,把携带序列号的也保存起来
		$FILE_UUID = getRandOnly_Id(0,1);
		//$af_path_serial = S_ROOT."xml/".$order_sn."_".$policy_id."_".$FILE_UUID."_ssbq_policy_post.xml";
		$af_path_serial = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_".$FILE_UUID."_ssbq_policy_post.xml");
		ss_log($af_path_serial);
		file_put_contents($af_path_serial,$strxml_post_policy_content);
		//end add by wangcya, 20150209,把携带序列号的也保存起来
		
		ss_log("ssbq will create_java_obj");
		////////////////////////////////////////////////////////////////////
		$java_class_name = 'com.yanda.imsp.util.ins.ssbqPolicyFecher';
		...
		$java_class_name = empty($java_class_name)?$java_class_name_ssbq:$java_class_name;
		//end add by wangcya, 20150112,for bug[203],启用异步方式和java通讯
		
		
		$obj_java = create_java_obj($java_class_name);//难道被调用生成多次导致阻塞。？？？
		////////////////////////////////////////////////////////////////////
		//$ret_af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_post_ret.xml";
		$ret_af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_post_ret.xml");
		$url = URL_POST_POLICY_ssbq;
		ss_log(__FUNCTION__.",ssbq URL_POST_POLICY_ssbq: ".$url);
		
		if(!defined('USE_ASYN_JAVA'))//add by wangcya, 20150112,for bug[203],启用同步方式和java通讯
		{//同步方式
			//进行投保的工作
			ss_log("ssbq will java applyPolicy");
			$strxml_post_policy_ret = (string)$obj_java->applyPolicy( $url , $strxml_post_policy_content, $partnerCode );
			if(!empty($strxml_post_policy_ret))
			{			
				ss_log("ssbq will process return_data");
				...
				//////////////////////////////////////////////////////////////////////////
				$result_attr = process_return_xml_data_ssbq(
											                        $policy_id,
											                      	$orderNum,
																	$order_sn,
																	$strxml_post_policy_ret,
		...
		else
		{
			...
			*/
			...
			$postXmlEncoding = "UTF-8";
			$respXmlFileName = $ret_af_path;
			$logFileName = S_ROOT."xml/log/ssbq_postpolicy_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
...
function gen_xml_getpolicyfile_ssbq_tj_property($policy_attr,
												$user_info_applicant										  
												)
{
	global $_SGLOBAL;
...
function gen_xml_getpolicyfile_ssbq_tj_family_property(   $policy_attr								 
														)
{
	global $_SGLOBAL;
	//////////////////////////////////////////////////////////////
	...
	ss_log(__FUNCTION__.", ssbq   get policy file ,rand gen UUID: ".$UUID);
	...
	ss_log("ssbq  get policy file order_sn: ".$order_sn." policyNo: ".$policyNo);
...
function gen_xml_getpolicyfile_ssbq(   $policy_attr,
                                  $user_info_applicant,
								  $list_subject,
								  $partnerCode								 
								)
{
	...
	ss_log("ssbq   get policy file ,rand gen UUID: ".$UUID);
...
function process_return_xml_data_getpolicyfile_ssbq_ssbq_tj_property($policy_attr,
		                                        $return_data,
												$pdf_path,
												$obj_java)
{
...
//家财
function process_return_xml_data_getpolicyfile_ssbq_ssbq_tj(	$policy_attr,
		                                        $return_data,
												$pdf_filename
												)
{
	...
	if($messageStatusCode=='000000')//ok
	{
		...
		if(isset($epolicyPDF) && ($plcElcStatus == 1))
		{
			...
			$result_attr = get_policy_pdf_file_ssbq_tj_property($policy_attr['policy_id'],
...
function process_return_xml_data_getpolicyfile_ssbq(	$policy_attr,
		                                        $return_data,
												$pdf_path,
												$obj_java
												)
...
function get_policyfile_ssbq_tj_property_xml(
				                             $use_asyn,
				                             $policy_attr,
											 $user_info_applicant,
				                             $pdf_filename				
											)
{
	...
	$order_sn = $policy_attr['order_sn'];
	////////////////////////////////////////////////////////////////////////////////
	//$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_tj_property_policy_get_pdf.xml";
	$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_tj_property_policy_get_pdf.xml");
	ss_log(__FUNCTION__.", ".$af_path);
	
	if($policy_attr['attribute_type'] == 'tj_property'
	|| $policy_attr['attribute_type'] == 'tj_project')
	{
		$xml_get_policy = gen_xml_getpolicyfile_ssbq_tj_family_property($policy_attr);
		$partnercode = PARTNERCODE_TJ_FAMILY_PROPERTY;
	}
	else
	{
		$xml_get_policy = gen_xml_getpolicyfile_ssbq_tj_property($policy_attr,
															$user_info_applicant										  
															);
	...
	{
		$result = 112;
		$retmsg = "gen_xml_getpolicyfile_ssbq return null!";
		ss_log($retmsg);
	...
	//$ret_af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_tj_property_policy_get_pdf_ret.xml";
	$ret_af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_tj_property_policy_get_pdf_ret.xml");
	ss_log($ret_af_path);
	$logFileName = S_ROOT."xml/log/ssbq_tj_property_getpolicyfile_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
	if(!$use_asyn)//同步
	{
		ss_log(__FUNCTION__.", 将使用同步过程获取太平洋电子保单");
		ss_log(__FUNCTION__.", ssbq will applyPolicy");	
		...
		if($return_data)
		{
			ss_log(__FUNCTION__.", ssbq tj property return_data is not empty!");
			ss_log(__FUNCTION__.", return get policy file data:".$return_data);
		
			file_put_contents($ret_af_path,$return_data);
			////////////////////////////////////////////////////////////////////////
			
			$result_attr = process_return_xml_data_getpolicyfile_ssbq_ssbq_tj_property( 	 $policy_attr,//add by wangcya, 20150205
							                                                         $return_data,
									                                                 $pdf_filename , 
									                                                 $obj_java 
									                                             );
...
function get_policyfile_ssbq_tj_family_property_xml($use_asyn,
		                                      $policy_attr,
											  $pdf_path)
{
	...
	$order_sn = $policy_attr['order_sn'];
	$partnerCode = PARTNERCODE_TJ_FAMILY_PROPERTY;
	$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_get_pdf.xml");
	ss_log(__FUNCTION__.", ".$af_path);
	...
	////////////////////////////////////////////////////////////////////
	$url = URL_POST_POLICY_ssbq_TJ_PROPERTY;
	ss_log(__FUNCTION__.", ssbq get policy file url: ".$url);
	
	//$ret_af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_get_pdf_ret.xml";
	$ret_af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_get_pdf_ret.xml");
	ss_log(__FUNCTION__.", ".$ret_af_path);
	$logFileName = S_ROOT."xml/log/ssbq_tj_getpolicyfile_java_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
	if(!$use_asyn)//同步
	{
		ss_log(__FUNCTION__.", 将使用同步过程获取太平洋电子保单");
		ss_log(__FUNCTION__.", ssbq will applyPolicy");	
		...
		if($return_data)
		{
			ss_log(__FUNCTION__.", ssbq return_data is not empty!");
			ss_log(__FUNCTION__.", return get policy file data:".$return_data);
		
			file_put_contents($ret_af_path,$return_data);
			////////////////////////////////////////////////////////////////////////
			//
			$result_attr = process_return_xml_data_getpolicyfile_ssbq_ssbq_tj( 	 $policy_attr,
					                                                         $return_data,
							                                                 $pdf_path  
	...
	else
	{
		...
		$postXmlEncoding = "UTF-8";
		$respXmlFileName = $ret_af_path;
		$logFileName = S_ROOT."xml/log/ssbq_tj_getpolicyfile_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
...
//得到电子保单
function get_policyfile_ssbq_yiwai_xml($use_asyn,
		                                      $policy_attr,
			                                  $user_info_applicant,
											  $list_subject,
											  $pdf_path
											 )
{
	...
	$partnerCode = "U9Y";
	////////////////////////////////////////////////////////////////////////////////
	//$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_get_pdf.xml";
	$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_get_pdf.xml");
	ss_log($af_path);
	
	$xml_get_policy = gen_xml_getpolicyfile_ssbq(	$policy_attr,
												$user_info_applicant,
												$list_subject,
												$partnerCode											  
												);
	...
	if(!$use_asyn)//!defined('USE_ASYN_JAVA'))
	{
		$java_class_name = $java_class_name_ssbq;
	}
	else
	{
		$java_class_name = "com.demon.insurance.pub.InsuranceDispatcher";
	...
	////////////////////////////////////////////////////////////////////
	$url = URL_POST_POLICY_ssbq;
	ss_log("ssbq URL_GET_POLICY_FILE_ssbq: ".$url);
	...
	if(!$use_asyn)//同步
	{
		...
		if($return_data)
		{
			...
			$result_attr = process_return_xml_data_getpolicyfile_ssbq( 	 $policy_attr,//add by wangcya, 20150205
			                                                         $return_data,
					                                                 $pdf_path , 
					                                                 $obj_java 
					                                             );
	...
	else
	{
		...
		$postXmlEncoding = "UTF-8";
		$respXmlFileName = $ret_af_path;
		$logFileName = S_ROOT."xml/log/ssbq_getpolicyfile_java_asyn_".date("Y-m-d")."_".$order_sn."_".$policy_id.".log";
...
function get_policyfile_ssbq_tj_property($pdf_filename,
											$policy_attr,
											$user_info_applicant)
{
	ss_log("into ".__FUNCTION__);
	...
	$use_asyn = false;
	$result_attr = get_policyfile_ssbq_tj_property_xml(
							                             $use_asyn,
							                             $policy_attr,
														 $user_info_applicant,
							                             $pdf_filename				
...
//获取电子保单
function get_policyfile_ssbq_yiwai(	 $pdf_filename,
		                                     $policy_attr,
											 $user_info_applicant,
											 $list_subject
										 )
...
function withdraw_policyfile_ssbq_tj_property($policy_attr,
									 			$user_info_applicant)
{
	global $_SGLOBAL;
	//////////////////////////////////////////////////////////////
	...
	ss_log(__FUNCTION__." ssbq withdraw order_sn: ".$order_sn." policyNo: ".$policyNo);
	
	$UUID = getRandOnly_Id(0);//这个要求每次在变化。
	
	ss_log("ssbq withdraw,rand gen UUID: ".$UUID);
	
	$url = URL_POST_POLICY_ssbq_TJ_PROPERTY;
	ss_log("ssbq withdraw url: ".$url);
...
<request>
	...
	$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_tj_property_policy_withdraw.xml";
	file_put_contents($af_path,$xml_withdraw_policy);
	$af_path_serial = S_ROOT."xml/".$order_sn."_".$policy_id."_".$UUID."_ssbq_tj_property_policy_withdraw.xml";
	...
	if($return_data)
	{
		...
		$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_tj_property_policy_withdraw_ret.xml";
			...
			$messageId_ret == $UUID	)//ok
		{
			...
			if($policyNo_ret != $policyNo)//返回保单号不等于发送的保单号
			{
				...
				$result = 110;
				$retmsg = "返回保单号不等于发送的保单号,ssbq withdraw ret policyNo: ".$policyNo_ret;
				ss_log($retmsg);
			...
			////////////////////////////////////////////////////////////////////////
			$result = 0;
			$retmsg = "ssbq withdraw policy success!";
			ss_log($retmsg);
		}
		else
		{
...
////注销保单
function withdraw_policyfile_ssbq_yiwai( $policy_attr,
									 			$user_info_applicant
												)
{
	global $_SGLOBAL;
	//////////////////////////////////////////////////////////////
	ss_log("into function withdraw_policyfile_ssbq_yiwai");
	...
	ss_log("ssbq withdraw order_sn: ".$order_sn." policyNo: ".$policyNo);
	...
	//$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_withdraw.xml";
	$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_withdraw.xml");
	file_put_contents($af_path,$xml_withdraw_policy);

	//start add by wangcya, 20150209,把携带序列号的也保存起来
	//$af_path_serial = S_ROOT."xml/".$order_sn."_".$policy_id."_".$UUID."_ssbq_policy_withdraw.xml";
	$af_path_serial = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_".$UUID."_ssbq_policy_withdraw.xml");
	file_put_contents($af_path_serial,$xml_withdraw_policy);
	//end add by wangcya, 20150209,把携带序列号的也保存起来
	/////////先解析出来返回的xml//////////////////////////////////
	...
	if($return_data)
	{
		...
		//$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_withdraw_ret.xml";
		$af_path = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_withdraw_ret.xml");
		file_put_contents($af_path,$return_data);
		/////////先解析出来返回的xml//////////////////////////////////
...
$G_XLS_UPLOAD_FORMAT_ssbq_TJ_PROPERTY_TUANDAN = array(
					'1'=>'assured_name',
					'2'=>'assured_certificates_type',//被保险人证件类型
...
$G_XLS_UPLOAD_FORMAT_ssbq_TJ_PROPERTY_PILIANG = array(
					'1'=>'applicant_type',//投保人类型
					'2'=>'applicant_name',//投保人名
					'3'=>'applicant_certificates_type',//投保人证件类型
					'4'=>'applicant_certificates_code',//投保人证件号
...
function process_file_xls_ssbq_tj_property_insured($uploadfile)
{
	...
	////////////////////////////////////////////////////////////////////
	$path = dirname(S_ROOT);
	global $G_XLS_UPLOAD_FORMAT_ssbq_TJ_PROPERTY_TUANDAN;
	global $G_XLS_UPLOAD_FORMAT_ssbq_TJ_PROPERTY_PILIANG;
	...
	if(isset($_POST['commit_type']))
	{
		...
		{
			$result = process_file_xls_upload_common($uploadfile, NULL, $G_XLS_UPLOAD_FORMAT_ssbq_TJ_PROPERTY_TUANDAN,9);
		}
		//批量上传	
		elseif($commit_type == 'piliang')
		{
			$result = process_file_xls_upload_common($uploadfile, NULL, $G_XLS_UPLOAD_FORMAT_ssbq_TJ_PROPERTY_PILIANG);
		}
		else
		{
...
function process_file_xls_ssbq_insured_new_template($uploadfile)
{
	ss_log(__FUNCTION__.": ".$uploadfile);
	if(empty($uploadfile))
	{	
	...
	////////////////////////////////////////////////////////////////////
	$path = dirname(S_ROOT);
	 global $G_XLS_UPLOAD_FORMAT_ssbq_YIWAI;
	global $G_XLS_UPLOAD_FORMAT_ssbq_TUANDAN;
	//自己设置的上传文件存放路径
	require_once $path.'/oop/lib/Excel/PHPExcel.php';
	require_once $path.'/oop/lib/Excel/PHPExcel/IOFactory.php';
	require_once $path.'/oop/lib/Excel/PHPExcel/Reader/Excel5.php';
	...
	if(isset($_POST['commit_type']))
	{
		...
		if($commit_type == 'tuandan')
		{
			$result = process_file_xls_upload_common($uploadfile, '', $G_XLS_UPLOAD_FORMAT_ssbq_TUANDAN,9);
		}
	}
	else//兼容原有的批量导入功能分之代码
	{
		$result = process_file_xls_upload_common($uploadfile, '', $G_XLS_UPLOAD_FORMAT_ssbq_YIWAI);
	}
...
//	
//    global $G_XLS_UPLOAD_FORMAT_ssbq_YIWAI;
//    $format_arr=$G_XLS_UPLOAD_FORMAT_ssbq_YIWAI;
//	$rows = array();
...
function process_file_xls_ssbq_insured($uploadfile)//$file,$filetempname
{
...
//导入职业类别的Excel文件
function process_file_xls_ssbq_occupationClassCode($uploadfile)//$file,$filetempname
{
	////////////////////////////////////////////////////////////////////
	$path = dirname(S_ROOT);
...
//发送信息到救援公司
function ssbq_send_message_to_jiuyuan($attribute_code,
											$order_sn,
											 $policy_id,
											 $strxml_post_policy,
											 $strxml_post_policy_ret
		                                     )
{
	...
	ss_log("ssbq jiuyuan url: ".$url);
	
	//$ret_af_path = $return_data_jiuyuan_file = S_ROOT."xml/".$order_sn."_".$policy_id."_huanqiu_policy_post_jiuyuan_ret.xml";
	$ret_af_path = $return_data_jiuyuan_file = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_huanqiu_policy_post_jiuyuan_ret.xml");
	...
	{//同步方式
		...
		ss_log("使用同步方式，ssbq will 发送报文到救援公司");
	...
	{//异步方式
		...
		//$af_path_ret = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_post_ret.xml";
		$af_path_ret = gen_file_fullpath('policy','ssbq',S_ROOT, $order_sn."_".$policy_id."_ssbq_policy_post_ret.xml");
...
function process_return_xml_data_huanqiu_ssbq(
										$policy_id,
										$return_data
									   )
{
...
function rescue_policy_ssbq($policy_id)
{
	global $_SGLOBAL;
	...
	$af_path = S_ROOT."xml/".$order_sn."_".$policy_id."_ssbq_policy_post_ret.xml";
	ss_log($af_path);
...
function process_upload_file($data=array(),$category='')
{
	ss_log("into ".__FUNCTION__);
	include_once('function_baoxian.php');
	global $_SGLOBAL,$required_upload_file_attr,$other_file_attr;
	/* 允许上传的文件类型 */
	$allow_file_types = '|GIF|JPG|PNG|BMP|SWF|DOC|DOCX|XLS|XLSX|PPT|MID|WAV|ZIP|RAR|PDF|CHM|RM|TXT|';
	$data_id = 0;
	if($category=='insurance_policy')
	{
		$save_dir = $category."_attachment_$data[policy_id]";
		$data_id = $data['policy_id'];
	}
	
	//重要文件，必须上传的
	$attachment_info = array();

	foreach ($required_upload_file_attr as $key_p => $required_info) 
	{
		
		$files = isset($_REQUEST[$key_p])?$_REQUEST[$key_p]:null;
    	ss_log(__FUNCTION__.",".$key_p);
		
		if(is_array($files))
		{
			if(!empty($files))
			{
				$files__arr_str=implode(",",$files);
				
			}
		}
		else
		{
			$files__arr_str = $files;
			
		}
		
	    if ($files__arr_str)
        {
	        $row = array('field_name'=>$key_p,'field_desc'=>$required_info['name'],'value'=>$files__arr_str,'inner_category'=>'required_info');
	        $attachment_info[] = $row;
	        $files__arr_str="";
	        $files = null;
        }
	...
	//上传其他
	foreach ( $other_file_attr as $key_o => $other_file) 
	{
		$files = isset($_REQUEST[$key_o])?$_REQUEST[$key_o]:null;
    	ss_log(__FUNCTION__.",".$key_o);
	    ...
	    if ($files__arr_str)
        {
    		$row = array('field_name'=>$key_o,'field_desc'=>$other_file['name'],'value'=>$files__arr_str,'inner_category'=>'other_info');
	        $attachment_info[] = $row;
	        $files__arr_str="";
	        $files = null;
	...
	$temp_str = print_r($attachment_info,true);
	ss_log("temp_str:".$temp_str);
	
	// 入库
	foreach ( $attachment_info as $key => $attachment ) 
	{
		
		$attachment['data_id'] = $data_id;
		$attachment['category'] = $category;
		
		$wheresql = " field_name='$attachment[field_name]' AND data_id='$data_id'";
		//判断是否存在，如果存在，更新，否则新增
		$sql = "SELECT * FROM ".tname('attachment')." WHERE $wheresql LIMIT 1";
		ss_log("判断是否存在，如果存在，更新，否则新增:".$sql);
		
		
		$query = $_SGLOBAL['db']->query($sql);
		$old_attachment = $_SGLOBAL['db']->fetch_array($query);
		if(empty($old_attachment))
		{
			inserttable("attachment",$attachment);
		}
		else
		{
			if($old_attachment['value'])
			{
				$attachment['value']=$old_attachment['value'].",".$attachment['value'];
			}
			updatetable('attachment',$attachment,array('id'=>$old_attachment['id']));
		}
...
/* 上传文件 */
function bx_upload_article_file($upload,$save_dir)
{
	define('TEMP_ROOT_PATH', str_replace('baoxian/source/function_baoxian_ssbq.php', '', str_replace('\\', '/', __FILE__)));
	$file_dir = 'attachment';//附件
	
    if (!make_dir("../" . $file_dir . "/$save_dir"))
    {
        /* 创建目录失败 */
        return false;
    }

    $filename = bx_random_filename() . substr($upload['name'], strpos($upload['name'], '.'));

    $path     = TEMP_ROOT_PATH. $file_dir . "/$save_dir/" . $filename;

    if (bx_move_upload_file($upload['tmp_name'], $path))
    {
        return $file_dir . "/$save_dir/" . $filename;
    }
    else
    {
        return false;
 ...
 * @return blog
 */
function bx_move_upload_file($file_name, $target_name = '')
{
...
function bx_get_all_attachment($policy_id)
{
	global $_SGLOBAL;
	
	$attachment = array();
	$wheresql = " data_id='$policy_id' AND category='insurance_policy' ";
	
	$sql = "SELECT * FROM ".tname('attachment')." WHERE $wheresql ";
	$query = $_SGLOBAL['db']->query($sql);
	...
	while ($value = $_SGLOBAL['db']->fetch_array($query))
	{
	    if (strstr($value['value'], ',')) {
	    	$temp_array = array();
			$file_url_list = explode(",", $value['value']);
			$i=1;
			foreach ( $file_url_list as $key2 => $file_url ) {
       			$temp_array['url'] = $file_url;
       			$temp_array['name'] = $value['field_desc']."_".$i;
       			$value['file_url_list'][] = $temp_array;
				$temp_array = null;
				$i++;
			}
			$i=1;
	...
	$attachment['required_info'] = $required_info;
	$attachment['other_info'] = $other_info;
	
	$temp_str = print_r($attachment,true);
	ss_log("attachment:".$temp_str);
