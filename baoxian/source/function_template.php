...
function parse_template($tpl) {
	...
	//ss_log("template start");
	//��ģ��
	$_SGLOBAL['sub_tpls'] = array($tpl);

	//ss_log("parse_template, tpl: ".$tpl);
	//$objfile = S_ROOT.'./data/tpl_cache/'.str_replace('/','_',$tpl).'.php';
    
    if($_SGLOBAL['mobile_type'] != 'pcweb')
	{
		//ss_log("will process mobile parse_template");
	...
	//ss_log(" parse_template, objfile: ".$objfile);
	
	//ss_log(" parse_template, before tplfile: ".$tplfile);
	//read
	...
	//ss_log(" parse_template after tplfile: ".$tplfile);
...
function readtemplate($name) {
	...
	//ss_log("readtemplate, name: ".$name);
	if($_SGLOBAL['mobile_type'] != 'pcweb')
	{
		$tpl = strexists($name,'/')?$name:"template/mobile/$name";
		$tplfile = S_ROOT.'./'.$tpl.'.htm';
	}
	else
	{
	...
	//ss_log("readtemplate, before, tplfile: ".$tplfile);
	...
	//ss_log("readtemplate, after, tplfile: ".$tplfile);
