...
/*
	kangyq.com
	$Id: class_mysql.php 10484 2008-12-05 05:46:59Z  $
*/
...
define('D_BUG', 0);// add by wangcya , 20140810
...
class dbstuff {
	...
	function halt($message = '', $sql = '') {
		$dberror = $this->error();
		$dberrno = $this->errno();
		$help_link = "http://faq.kangyq.com/?type=mysql&dberrno=".rawurlencode($dberrno)."&dberror=".rawurlencode($dberror);
