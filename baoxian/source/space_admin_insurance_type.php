...
///////////////////////////////////////////////////////////////////
$theurl ="space.php?do=admin_insurance_type";

//http://127.0.0.1/baoxian/space.php?do=admin_product
...
if($id)
{
	...
	include_once template("space_admin_insurance_type_view");
}
else
{
	...
	if($count)
	{
		...
		$ordersql = " ORDER BY id";//dateline_update
		$sql = "SELECT * FROM ".tname('insurance_type')." WHERE $wheresql $ordersql LIMIT $start,$perpage";
	...
	$_TPL['css'] = "admin_product";
	include_once template("space_admin_insurance_type");
