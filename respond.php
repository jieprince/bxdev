...
//added by zhangxi, 20150511, 增加打印信息
ss_log(__FILE__.", get in");
ss_log(__FILE__.", enter respond callback, _GET=".var_export($_GET,true));
ss_log(__FILE__.", enter respond callback, _POST=".var_export($_POST,true));
...
else
{
    ...
    else
    {
        ...
        if (file_exists($plugin_file))
        {
            ...
            //comment by wangcya, 20150209, 这里回应支付宝等支付请求
