...
if($distributor_cfg)
{
	$url = 'goods_list.php?act=hot_goods_list';
	header("location: $url");
	exit;
...
$smarty->assign('hot_goods' , $index->getHotGoods());       
//获取广告轮播图的信息
$flash_data_xml=join("",file('../data/flash_data.xml'));                         
$flash_data_result = CommonUtils::xml_to_array($flash_data_xml);  
$smarty->assign('flash_data', $flash_data_result['item']);  
