...
//$_LANG['alipay_virtual_method_desc'] = '您可以选择支付时采用的接口类型，不过这和支付宝的账号类型有关，具体情况请咨询支付宝';
//$_LANG['alipay_virtual_method_range'][0] = '使用普通虚拟商品交易接口';
//$_LANG['alipay_virtual_method_range'][1] = '使用即时到账交易接口';
//
//$_LANG['alipay_real_method'] = '选择实体商品接口';
//$_LANG['alipay_real_method_desc'] = '您可以选择支付时采用的接口类型，不过这和支付宝的账号类型有关，具体情况请咨询支付宝';
//$_LANG['alipay_real_method_range'][0] = '使用普通实物商品交易接口';
//$_LANG['alipay_real_method_range'][1] = '使用即时到账交易接口';
//
//$_LANG['is_instant'] = '是否开通即时到账';
//$_LANG['is_instant_desc'] = '即时到账功能默认未开通，当您确认您的账号已经开通该功再选择已开通。当你选择未开通时，所有交易使用普通实体商品接口';
...
$_LANG['alipay_pay_method_range'][2] = '使用即时到账交易接口';
?>