...
$_LANG['kuaiqian_desc_icbc'] = '通过快钱账户，用户可以直接用工行网银支付。';
$_LANG['kuaiqian_desc_ccb'] = '通过快钱账户，用户可以直接用建设网银支付。';
$_LANG['kuaiqian_desc_abc'] = '通过快钱账户，用户可以直接用农业网银支付。';
$_LANG['kuaiqian_desc_bcom'] = '通过快钱账户，用户可以直接用交通网银支付。';
$_LANG['kuaiqian_desc_cmb'] = '通过快钱账户，用户可以直接用招商网银支付。';
$_LANG['kuaiqian_desc_cmbc'] = '通过快钱账户，用户可以直接用民生网银支付。';
$_LANG['kuaiqian_desc_sdb'] = '通过快钱账户，用户可以直接用深发网银支付。';
$_LANG['kuaiqian_desc_boc'] = '通过快钱账户，用户可以直接用中国网银支付。';
$_LANG['kuaiqian_desc_bob'] = '通过快钱账户，用户可以直接用北京网银支付。';

$_LANG['kq_account'] = '收款账号';
$_LANG['kq_account_desc'] = '人民币支付网关的收款账号为用户在快钱的用户编号后面附加数字01，即[用户编号01]';
$_LANG['kq_key']     = '商户密钥';
