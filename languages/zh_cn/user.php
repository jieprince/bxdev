...
$_LANG['label_invoice'] = '我的发票';
$_LANG['label_warranty'] = '我的保单';
$_LANG['label_address'] = '收货地址';
$_LANG['label_message'] = '我的留言';
$_LANG['label_tag'] = '我的标签';
$_LANG['label_collection'] = '我的收藏';
$_LANG['label_bonus'] = '我的代金券';
$_LANG['label_comment'] = '我的评论';
$_LANG['label_affiliate'] = '我的推荐';
$_LANG['label_group_buy'] = '我的团购';
$_LANG['label_booking'] = '缺货登记';
$_LANG['label_my_customer'] = '我的客户';
$_LANG['label_user_surplus'] = '资金管理';
$_LANG['bank_name'] = '银行账户';
$_LANG['add_bank'] = '添加账户';
$_LANG['edit_bank'] = '账户修改';
$_LANG['label_track_packages'] = '跟踪包裹';
$_LANG['label_transform_points'] = '积分兑换';
$_LANG['label_logout'] = '退出';
$_LANG['organ_check_infoing'] = '您身份是渠道，未审核通过，请完善渠道信息!';
$_LANG['check_infoing'] = '您当前是非正式会员，请完善个人信息!';
$_LANG['format_user_infoing'] = '您当前是正式会员!';
$_LANG['format_organ_infoing'] = '您身份是渠道，已审核通过!';
/* 银行账户信息 */
$_LANG['bank_user_name'] = '账户名称';
$_LANG['open_bank'] = '开户银行';
$_LANG['sub_branch'] = '开户行分行支行';
...
$_LANG['ji_gou'] = '渠道管理费';
$_LANG['tui_jian'] = '推荐奖励';
$_LANG['add_surplus_log'] = '账户明细';
$_LANG['transfer_accounts'] = '转账';
$_LANG['income_log'] = '收益明细';
$_LANG['view_application'] = '查看申请记录';
$_LANG['view_application_append'] = '充值记录';
$_LANG['view_application_subtract'] = '提现记录';
$_LANG['surplus_pro_type'] = '类型';
$_LANG['repay_money'] = '提现金额';
$_LANG['money'] = '金额';
$_LANG['transfer_money'] = '转账金额';
$_LANG['transfer_desc'] = '转账说明';
$_LANG['cname'] = '来源';
$_LANG['payee_name'] = '收款人';
...
$_LANG['back_account_log'] = '返回账户明细列表';
$_LANG['amount_gt_zero'] = '请在“金额”栏输入大于0的数字';
$_LANG['select_payment_pls'] = '请选择支付方式';
$_LANG['upload_pay_doc'] = '请上传支付凭证'; //add yes123 2014-12-12
...
$_LANG['account_js']['checkCode_desc'] = '短信动态验证有误！';
...
$_LANG['user_bonus'] = '用户代金券';
$_LANG['user_bonus_info'] = '共计 %d 个,价值 %s';
$_LANG['not_bonus'] = '没有代金券';
$_LANG['add_user_bonus'] = '添加一个代金券';
$_LANG['bonus_number'] = '代金券序列号';
$_LANG['old_password'] = '原密码';
$_LANG['new_password'] = '新密码';
$_LANG['confirm_password'] = '确认密码';

$_LANG['bonus_sn_exist'] = '此代金券号码已经被占用了！';
$_LANG['bonus_sn_not_exist'] = '此代金券号码不存在！';
$_LANG['add_bonus_sucess'] = '添加新的代金券操作成功！';
$_LANG['add_bonus_false'] = '添加新的代金券操作失败！';
...
$_LANG['submit_check_success'] = '提交成功，请等待管理员审核！';
$_LANG['edit_profile_failed'] = '修改个人资料操作失败！';
$_LANG['oldpassword_error'] = '您输入的旧密码有误!请确认再后输入！';

//JS语言项
$_LANG['profile_js']['bonus_sn_empty'] = '请输入您要添加的代金券号码！';
$_LANG['profile_js']['bonus_sn_error'] = '您输入的代金券号码格式不正确！';
...
$_LANG['confirm_edit'] = '保存'; // modify yes123 2014-01-06 把“确认修改” 修改为 “保存”;
$_LANG['submit_check'] = '提交审核';

$_LANG['confirm_drop_address'] = '你确认要删除该收货地址吗？';

/* 会员密码找回 */
$_LANG['username_and_email'] = '请输入您注册的用户名和注册时填写的电子邮件地址。';
$_LANG['enter_phonenumber'] = '请输入您的手机号码。';
...
/* 会员代金券 */
$_LANG['bonus_is_used'] = '你输入的代金券你已经领取过了！';
$_LANG['bonus_is_used_by_other'] = '你输入的代金券已经被其他人领取！';
$_LANG['bonus_add_success'] = '您已经成功的添加了一个新的代金券！';
$_LANG['bonus_not_exist'] = '你输入的代金券不存在';
$_LANG['user_bonus_empty'] = '您现在还没有代金券';
$_LANG['add_bonus_sucess'] = '添加新的代金券操作成功！';
$_LANG['add_bonus_false'] = '添加新的代金券操作失败！';
$_LANG['bonus_add_expire'] = '该代金券已经过期！';
$_LANG['bonus_use_expire'] = '该代金券已经过了使用期！';
...
$_LANG['order_money'] = '订单金额';
$_LANG['order_status'] = '订单状态';
$_LANG['insure_status'] = '投保状态';
...
$_LANG['pay_order_by_service_money'] = '追加使用金币支付订单：%s';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、代金券等）以第二个为准。';
$_LANG['subtotal'] = '小计';
$_LANG['goods_price'] = '商品价格';
$_LANG['goods_attr'] = '属性';
$_LANG['order_policy'] = '保单';
$_LANG['use_balance'] = '使用余额';
$_LANG['order_postscript'] = '订单附言';
$_LANG['order_number'] = '订单号';
$_LANG['policy_number'] = '保单号';
...
$_LANG['use_more_service_money'] = '追加使用金币';
$_LANG['max_surplus'] = '（您的账户余额：%s）';
$_LANG['button_submit'] = '确定';
$_LANG['order_detail'] = '订单详情';
$_LANG['error_surplus_invalid'] = '您输入的数字不正确！';
$_LANG['error_order_is_paid'] = '该订单不需要付款！';
$_LANG['error_surplus_not_enough'] = '您的账户余额不足！';
$_LANG['error_service_money_not_enough'] = '您的金币账户余额不足！';
/* 订单状态 */
...
$_LANG['agreement'] = "我已看过并接受《<a href=article.php?act=article_detail&article_type=article&id=6  style=color:#EC6941 target=_blank>用户协议</a>》";
...
/* 代金券详情 */
$_LANG['bonus_sn'] = '代金券序号';
$_LANG['bonus_name'] = '代金券名称';
$_LANG['bonus_amount'] = '代金券金额';
$_LANG['min_goods_amount'] = '最小订单金额';
$_LANG['bonus_end_date'] = '截至使用日期';
$_LANG['bonus_status'] = '代金券状态';
...
$_LANG['affiliate_code'] = '我要推荐';
$_LANG['other_affiliate'] = '其他推荐';
$_LANG['email_affiliate'] = '邮件推荐';
...
$_LANG['reg_time'] = '注册时间';
$_LANG['income_total'] = '佣金总计';
$_LANG['is_cheack'] = '是否审核';
...
/* 用户信息 */
$_LANG['CertificatesType'] = '证件类型：';
$_LANG['Type'][0] = '身份证';
$_LANG['Type'][1] = '军官证';
$_LANG['Type'][2] = '驾驶证';
$_LANG['CardId'] = '身份证号：';
$_LANG['Category'] = '资格证书类别：';
$_LANG['Category_case'][0] = '经纪人';
$_LANG['Category_case'][1] = '代理人';
$_LANG['Category_case'][2] = '展业证';
$_LANG['CertificateNumber'] = '资格证书编号：';
...
/* 提现银行 */
$_LANG['deposit_bank'] = '提现银行';

/* 渠道 */
$_LANG['user_name'] = '渠道名称'; 
$_LANG['isMember'] = '是否正式会员';
$_LANG['identificationcode'] = '企业组织代码';
$_LANG['type2'] = '渠道类型';
$_LANG['qualificationNumber'] = '从业资格证书';
$_LANG['contacts'] = '联系人';
$_LANG['mobilePhone'] = '移动电话';
$_LANG['email'] = 'Email地址';
$_LANG['zone'] = '所在地';
$_LANG['qq'] = 'QQ';
$_LANG['addres'] = '详细地址';
...
$_LANG['one_week']= '最近一周';
$_LANG['one_month']= '一个月';
$_LANG['three_month']= '三个月';
$_LANG['six_month']= '六个月';
$_LANG['order_cancel'] = '已取消';
$_LANG['order_pay'] = '已付款';
$_LANG['order_arrearage'] = '未付款';
?>