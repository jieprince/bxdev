...
$_LANG['cs'][CS_PAYFINISHED] = '已确认，已付款';
...
$_LANG['cs'][OS_RETURNED] = '退保';
$_LANG['cs'][OS_SHIPPED_PART] = '部分发货';
//added by zhangxi, 20150214, 订单的查询，增加支付成功，投保失败的查询
$_LANG['cs'][CS_PAYFINISHED_INSURE_FAILED] = '已确认，已付款，投保失败(异常)';
...
$_LANG['os'][OS_RETURNED] = '<font color="red">退保</font>';
...
/* 订单列表 */
//start add by wangcya , 20140902

$_LANG['fee'][0] = '未结算';
$_LANG['fee'][1] = '已结算';
$_LANG['fee_status'] = '服务费状态';
$_LANG['policy_id'] = '投保单';
//end add by wangcya , 20140902
...
$_LANG['bonus_not_available'] = '该订单使用代金券支付，现在代金券不可用';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、代金券等）以主订单为准。';
...
$_LANG['return_order_surplus'] = '取消订单，退回支付订单 %s 时使用的预付款';
//$_LANG['return_order_integral'] = '由于取消、无效或退货操作，退回支付订单 %s 时使用的积分';
$_LANG['return_order_integral'] = '取消订单，退回支付订单 %s 时使用的积分';
