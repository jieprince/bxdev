...
//add yes123 2015-05-08 服务费率校验不合法提示文字
$_LANG['js_languages']['rate_myself_amount_not_number'] = '订单服务费格式不正确（数字）';
$_LANG['js_languages']['rate_recommend_amount_not_number'] = '推荐服务费格式不正确（数字）';
$_LANG['js_languages']['rate_organization_not_number'] = '渠道格式不正确（数字）';
