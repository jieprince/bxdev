...
$_LANG['distributor_manage'] = '渠道个人管理';
$_LANG['organization_manage'] = '渠道管理'; 
$_LANG['insurance_product_manage'] = '保险产品';
$_LANG['proposal_list'] = '投保单列表';
...
//会员信息管理
$_LANG['integrate_users'] = '会员整合';
//$_LANG['sync_users'] = '同步会员数据';
//$_LANG['users_manages'] = '添加会员';
...
$_LANG['users_add'] = '添加会员';
$_LANG['account_manage'] = '会员账户管理';
$_LANG['user_update'] = '修改会员资料'; 
$_LANG['user_remove'] = '删除会员';
$_LANG['users_list'] = '会员列表';
$_LANG['reservation'] = '咨询预约';
//权限管理部分的权限
...
$_LANG['admin_insurance_policy'] = '保单列表';
$_LANG['invoice_list'] = '发票列表';
$_LANG['policy_operation_log'] = '保单操作日志';
//促销管理
$_LANG['snatch_manage'] = '夺宝奇兵';
$_LANG['bonus_manage'] = '代金券管理';
...
//渠道管理
$_LANG['organization_add']    = '添加渠道';
$_LANG['organization_edit']    = '编辑渠道';
$_LANG['organ_ipa_rate_config_add']    = '添加佣金配置 ';
$_LANG['organ_ipa_rate_config_edit']    = '编辑佣金配置 ';
$_LANG['rate_config_remove']    = '删除佣金配置 ';
...
$_LANG['account_add'] = '添加账户';
$_LANG['account_list'] = '银行账户列表';
$_LANG['admin_web_account'] = '实际账户记录';
$_LANG['revenue_ranking'] = '收入排行';
$_LANG['surplus_manage'] = '充值申请';
$_LANG['surplus_manage2'] = '提现申请';
