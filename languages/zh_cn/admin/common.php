...
$_LANG['app_name'] = '保险平台';
$_LANG['cp_home'] = '保险平台 管理中心';
$_LANG['copyright'] = '版权所有@2014 北京保易通信息技术有限公司，中天信合保险代理（北京）有限公司';
...
/* 菜单分类部分 */
$_LANG['02_insurance_product_manage'] = '保险产品';
$_LANG['03_cat_and_goods'] = '商品管理';
$_LANG['03_promotion'] = '促销管理';
$_LANG['04_order'] = '订单管理';
$_LANG['05_banner'] = '广告管理';
$_LANG['09_stats'] = '报表统计';
$_LANG['08_content'] = '内容管理';
$_LANG['01_members'] = '会员管理';
$_LANG['09_others'] = '杂项管理';
$_LANG['10_priv_admin'] = '权限管理';
$_LANG['05_system'] = '系统设置';
$_LANG['12_template'] = '模板管理';
$_LANG['13_backup'] = '数据库管理';
$_LANG['14_sms'] = '短信管理';
$_LANG['07_rec'] = '推荐管理';
$_LANG['16_email_manage'] = '邮件群发管理';
$_LANG['17_distributor_manage'] = '渠道个人管理';
$_LANG['18_organization_manage'] = '渠道管理';
$_LANG['06_bank_account'] = '财务管理';

//add yes123 2015-04-08
$_LANG['20_app_manage'] = 'app管理';
$_LANG['app_update_manage'] = '升级管理';
$_LANG['21_en_site_manage'] = '企业站管理';
$_LANG['22_weixin_manage'] = '微信端管理';
...
$_LANG['04_bonustype_list'] = '代金券类型';
$_LANG['bonustype_add'] = '添加代金券类型';
$_LANG['05_bonus_list'] = '线下代金券';
$_LANG['bonus_add'] = '添加会员代金券';
...
$_LANG['give_product_cfg'] = '代理人产品赠送配置';
$_LANG['meeting_list'] = '参会报名';
...
$_LANG['01_policy_list'] = '保单列表';
$_LANG['11_invoice_list'] = '发票列表';
$_LANG['20_policy_operation_log'] = '保单操作日志';
...
$_LANG['09_child_account'] = '子账户管理';
$_LANG['03_users_list'] = '会员列表';



$_LANG['04_funds_management'] = '资金管理';
$_LANG['05_user_rank_list'] = '会员等级';
$_LANG['06_reservation'] = '咨询预约';
...
$_LANG['admin_logs'] = '系统日志';
$_LANG['agency_list'] = '办事处列表';
$_LANG['suppliers_list'] = '供货商列表';

/* 系统设置 */
$_LANG['01_shop_config'] = '系统配置';
$_LANG['shop_authorized'] = '授权证书';
$_LANG['shp_webcollect'] = '网罗天下';
$_LANG['10_payment_list'] = '支付方式配置';
$_LANG['02_balance_payment'] = '余额支付';
...
/*渠道管理*/
$_LANG['salesman_list'] = '会员管理';
$_LANG['distributor_info'] = '渠道信息';


/*渠道管理*/
$_LANG['organization_list'] = '渠道列表';
$_LANG['organ_ipa_rate_config'] = '渠道产品佣金配置';
//$_LANG['organization_check'] = '待审渠道';
$_LANG['ischeck'] = '审核状态';
$_LANG['check'][0] = '待审中';
$_LANG['check'][1] = '已审核';
/* 账户管理 */
$_LANG['bank_account'] = '财务管理';
$_LANG['account_list'] = '网站账号配置';
$_LANG['account_add'] = '网站账号配置';
$_LANG['admin_web_account'] = '实际账户记录';
$_LANG['revenue_ranking'] = '综合统计';
//modify yes123 2014-12-19 重置和提现分开
$_LANG['09_user_account'] = '受理用户充值';
$_LANG['09_user_account2'] = '受理提现请求';
$_LANG['withdraw_rule_cfg_list'] = '提现规则';
$_LANG['04_user_account'] = '提现受理';
$_LANG['05_user_account'] = '账户调节';
$_LANG['10_user_account_manage'] = '资金管理';

/* 银行账户信息 */
$_LANG['bank_user_name'] = '户名';
...
/*保险产品子菜单 $_LANG['19_insurance_product_manage'] = '保险产品';*/
$_LANG['admin_insurance_user'] = '用户列表';
$_LANG['admin_insurance_type'] = '险种类别';
$_LANG['admin_insurance_company'] = '保险公司';
$_LANG['admin_insurance_duty'] = '保险责任';
$_LANG['admin_career_category'] = '职业分类';
$_LANG['admin_insurance_product_attribute'] = '险种';
$_LANG['admin_insurance_product'] = '保险产品';
$_LANG['admin_insurance_interface'] = '保险接口';
$_LANG['03_cancel_policy_list'] = '注销保单';

$_LANG['admin_insurance_proposal_list'] = '投保单列表';
/* 积分兑换管理 */
...
/*企业站管理*/
$_LANG['01_index_menu'] = '首页导航菜单';
$_LANG['02_flashplay'] = '首页轮播图';
$_LANG['02_ins_services'] = '首页保险服务';
$_LANG['03_articlecat_list'] = '文章分类';
$_LANG['04_article_list'] = '文章列表';
