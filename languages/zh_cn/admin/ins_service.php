...
$_LANG['brand_name'] = '类型名称';
$_LANG['site_url'] = '类型链接';
$_LANG['brand_desc'] = '描述';
$_LANG['brand_logo'] = '类型LOGO';
$_LANG['sort_order'] = '排序';
$_LANG['is_show'] = '是否显示';
...
$_LANG['brand_edit_lnk'] = '重新编辑';
$_LANG['brand_list_lnk'] = '返回列表页面';

/*帮助信息*/
$_LANG['up_brandlogo'] = '请上传图片，做为类型的LOGO！';
$_LANG['warn_brandlogo'] = '你已经上传过图片。再次上传时将覆盖原图片！';

/*提示信息*/
$_LANG['brand_edit'] = '编辑企业首页保险服务记录';
$_LANG['upload_failure'] = '图片上传失败！';
$_LANG['brandedit_fail'] = ' %s 修改失败！';
$_LANG['brandadd_succed'] = '添加成功！';
$_LANG['brandedit_succed'] = '名称 %s 修改成功！';
$_LANG['brandname_exist'] = '名称 %s 已经存在！';
...
/*JS 语言项*/
$_LANG['js_languages']['no_brandname'] = '您必须输入名称！';
