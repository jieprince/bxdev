...
*/
/* 列表页面 */
$_LANG['label_user_realname'] = '姓名';
$_LANG['label_user_mobilephone'] = '手机号码';
$_LANG['label_user_email'] = '邮箱';
$_LANG['04_users_add'] = '添加会员';//add yes123 2014-12-22
 ...
 */
$_LANG['check'] = '审批';
$_LANG['qualified'] = '审核通过';
$_LANG['disqualification'] = '审核不通过';
$_LANG['ischeack'] = '是否已审批';
$_LANG['is_twodimension'] = '是否生成二维码';
$_LANG['last_time'] = '更新时间';
$_LANG['check_status'] = '申请审核';
$_LANG['referrer'] = '推荐人';
/*
 *修改结束
 */
 ...
 * 作用: 审批栏标题
 */
$_LANG['is_cheack'][0] = '未审批';
$_LANG['is_cheack'][1] = '已审批';
$_LANG['is_institution'][1] = '普通会员';
$_LANG['is_institution'][2] = '渠道会员';
$_LANG['is_institution'][3] = '团队长';
/*
 *修改结束
 */
...
$_LANG['service_money'] = '服务费资金';
$_LANG['award_money'] = '奖励资金';
...
$_LANG['parent_remove'] = '脱离推荐关系';//add yes123 2015-04-28 
$_LANG['institution_remove'] = '脱离渠道关系'; //add yes123 2015-04-28 
//add yes123 2015-01-07 添加推荐人
$_LANG['add_parent_user'] = '添加推荐人';
$_LANG['add_institution_user'] = '添加渠道';
...
$_LANG['edit_cardId_failed'] = '证件号已存在。';
$_LANG['edit_certificateNumber_failed'] = '资格证编号已存在。';
$_LANG['edit_phone_failed'] = '手机号码已存在。';
...
$_LANG['CertificateNumber'] = '证书编号:';
$_LANG['certificate_expiration_date'] = '资格证有效期:';
