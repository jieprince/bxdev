...
class cls_mysql
{
    ...
    //start add by wangcya ,20140802,关闭缓存 , http://blog.csdn.net/fgdfgasd/article/details/11929231
    //var $max_cache_time = 300; // 最大的缓存时间，以秒为单位
    var $max_cache_time = 0; // 最大的缓存时间，以秒为单位
    //end add by wangcya ,20140802,关闭缓存 , http://blog.csdn.net/fgdfgasd/article/details/11929231
