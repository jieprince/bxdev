...
function send_mail($name, $email, $subject, $content, $type = 0, $notification=false)
{
    ...
    {
    	//echo "mail_charset---config".$GLOBALS['_CFG']['mail_charset']."</br>";
    ...
    //echo "mail_service---config: ".$GLOBALS['_CFG']['mail_service'];
    if ($GLOBALS['_CFG']['mail_service'] == 0 && function_exists('mail'))
    {
    	//echo "not snmp send mail! </br>";
        /* 邮件的头部信息 */
    ...
    else
    {
        ...
        //echo "mail_service---smtp_host: ".$GLOBALS['_CFG']['smtp_host']."</br>";
        //echo "mail_service---smtp_port: ".$GLOBALS['_CFG']['smtp_port']."</br>";
        //echo "mail_service---smtp_user: ".$GLOBALS['_CFG']['smtp_user']."</br>";
        //echo "mail_service---smtp_pass: ".$GLOBALS['_CFG']['smtp_pass']."</br>";
...
function gzip_enabled()
{
    ...
    if ($enabled_gzip === NULL)
    {
        ...
        $enabled_gzip = (isset($GLOBALS['_CFG']['enable_gzip']) && function_exists('ob_gzhandler'));
    }
