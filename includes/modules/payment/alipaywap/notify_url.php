...
if($verify_result) {//验证成功
	...
	$ROOT_PATH__= str_replace ( 'includes/modules/payment/alipaywap/notify_url.php', '', str_replace ( '\\', '/', __FILE__ ) ) ;
	include_once ($ROOT_PATH__ . 'api/EBaoApp/eba_logManager.class.php');
	Eba_LogManager::logPayResonse('postdata from alipay for alipaywap ');
	//end
	...
	if( ! empty($doc->getElementsByTagName( "notify" )->item(0)->nodeValue) ) {
		...
		$log_id = $log_id[1];
// 		Eba_LogManager::log('postdata from alipay for alipaywap logid '.$log_id);
...
// 			{
// 				Eba_LogManager::log('postdata alipay for alipaywap total_fee is checked fail '.$total_fee .' ');
// 				return false;
// 			}
