...
define('CS_PAYFINISHED',            103); // 已确认、已付款
//added by zhangxi, 20150214, 已经确认，已付款，投保失败
define('CS_PAYFINISHED_INSURE_FAILED',            104);
...
/* 账户明细类型 */
define('SURPLUS_SAVE',              0); // 为账户冲值
define('SURPLUS_RETURN',            1); // 从账户提款
...
define('SEND_BY_REG',               4); // 按注册新用户发放
define('SEND_BY_PARENT',            5); // 新用户审核通过给推荐人发放
...
/* 账号变动类型 */
define('ACT_SAVING',                0);     // 账户冲值
define('ACT_DRAWING',               1);     // 账户提款
define('ACT_ADJUSTING',             2);     // 调节账户
...
/*用户类型 add yes123 2015-07-08*/
define('COMMON_USER', 'common'); //普通会员
define('AUTHORIZE_USER', 'authorize');//认证会员
define('ADVISER_USER', 'adviser');//服务专员
define('ORGANIZATION_USER', 'organization');//渠道会员


/*代金券来源*/
define('REG_BONUS',       1); //注册代金券
define('RECOMMEND_BONUS', 2);//审核通过代金券
define('ORDER_BONUS',     3);//下订单赠送的代金券
/*短信发送*/
define('REG_VERIFICATION_CODE_SMS',         1);//注册验证码
define('RESET_PASSWORD',                    2);//重置密码
define('CHANGE_PHONE',                      3);//更换手机号
define('WITHDRAWALS_VERIFICATION_CODE_SMS', 4);//提现验证码
define('TRANSFER_VERIFICATION_CODE_SMS',    5);//转账验证码
define('CHECK_SMS',                         6);//审核短信
define('MANUALLY_SEND_SMS',                 7); //手动发送
define('SERVICE_CHARGE_SEND_SMS',           8);//服务费发送
define('BONUS_SEND_SMS',                    9);//代金券短信
define('VERIFICATION_CODE_SMS',             10);//其他
define('BINDING_PHONE_CODE_SMS',             11);//绑定手机号码


/*用户审核状态*/
define('SAVED_CHECK_STATUS', 'saved');//已保存
define('PENDING_CHECK_STATUS', 'pending');//待审核
define('CHECKED_CHECK_STATUS',    'checked');//已审核
define('NO_PASS_CHECK_STATUS',    'no_pass');//审核不通过


/*用户等级权限标志*/
define('IS_WITHDRAW_RANK', 'is_withdraw');//是否能提现
define('ORDER_SERVICE_MONEY_RANK', 'order_service_money');//订单服务费
define('RECOMMEND_SERVICE_MONEY_RANK',    'recommend_service_money');//推荐服务费
define('RECOMMEND_GIVE_USER_BONUS_RANK',    'recommend_give_user_bonus');//推荐赠送代金券
define('RECOMMEND_GIVE_SERVICE_MONEY_RANK',    'recommend_give_service_money');//推荐赠送金币



/*服务费类型*/
define('ORDER_SERVICE_MONEY', 'order_service_money');
define('ORGAN_SERVICE_MONEY', 'organ_service_money');
define('RECOMMEND_SERVICE_MONEY', 'recommend_service_money');

/*验证码有效期*/
/*验证码有效期和验证错误代码*/
define('VCODE_USEFUL_LIFE',    600);//单位为秒
define('CHECK_CODE_OK',    200);//验证码正确
define('CHECK_CODE_ERROR', 201);//验证码错误
define('CHECK_CODE_TIMEOUT', 202);//验证码已过期
define('CHECK_CODE_RETRY', 203);//请重新获取
define('ALLOW_GET_COUNT', 500);//每天只能获取验证码的次数
define('CODE_GET_OUT', 500);//超出当天获取次数


define('GET_CHECK_CODE_FAIL', 400);//获取验证码失败

define('APPID', 'wx9401a8ab419a30ff');
define('APPSECRET', '045ae00f57bde55afec7fffd708dfd91');


define('WEBSITE_ACCOUNT', 479);
